...
export const SETTINGS_SCHEMA = {
  ...
  ollamaHost: {
    ...
    requiresRestart: false,
    default: undefined as string | undefined,
    description: 'The base URL for the Ollama server (e.g., http://localhost:11434).',
    showInDialog: false,
  },
  ollamaModel: {
    type: 'string',
    ...
    requiresRestart: false,
    default: undefined as string | undefined,
    description: 'The Ollama model name to use (e.g., llama3.3, codellama:13b).',
    showInDialog: false,
  },
  ollamaEmbeddingModel: {
    ...
    requiresRestart: false,
    default: undefined as string | undefined,
    description: 'The Ollama model to use for embeddings (e.g., nomic-embed-text).',
    showInDialog: false,
  },
  ollamaToken: {
    type: 'string',
    label: 'Ollama Authentication Token',
    category: 'Ollama',
    requiresRestart: false,
    default: undefined as string | undefined,
    description: 'Bearer token for Ollama server authentication (optional).',
    showInDialog: false,
  },
